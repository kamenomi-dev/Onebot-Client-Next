...
var Friend = class _Friend {
   ...
   */
  SendMsg(message, auto_escape = false) {
...
`
  ...
  friend_map = /* @__PURE__ */ new Map();
  group_map = /* @__PURE__ */ new Map();
  group_member_map = /* @__PURE__ */ new Map();
  /**
   * Connect to websocket server.
   * @async
   */
